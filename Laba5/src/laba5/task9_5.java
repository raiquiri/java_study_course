...
public class task9_5 {
    public static void main(String[] args) {
        ...
        System.out.println("Ответ по формуле Ньютона: " + f(x,p,y0));
        System.out.println("Ответ по функции: " + Math.pow(x,1/p));
        System.out.println("Погрешность: " + Math.abs(f(x,p,y0) - Math.pow(x,1/p)));

    }
    public static double f(double x, double p, double y0) {
        int k = 1;

...
public class test5 {
    public static void main(String[] args) {
        ...
        System.out.println("y >= " + k(-1,-1,2,0) + " * x + " + b(-1,-1,2,0));
        System.out.println("y <= " + k(1,5,2,0) + " * x + " + b(1,5,2,0));
        System.out.println("y <= " + 0 +" * x + " + 5);
        System.out.println("x >= " + -1);
        System.out.println("//  Block 2");
        System.out.println("y >= " + k(-1,-1,1,-3) + " * x + " + b(-1,-1,1,-3));
        System.out.println("y >= " + k(1,-3,2,0) + " * x + " + b(1,-3,2,0));
        System.out.println("y <= " + k(-1,-1,2,0) + " * x + " + b(-1,-1,2,0));
        System.out.println("//  Block 3");
        System.out.println("y <= Math.pow(Math.pow(2,2)-Math.pow(x+1,2),1/2.f) + 1");
        System.out.println("y >= -1 * (Math.pow(Math.pow(2,2)-Math.pow(x+1,2),1/2.f) + 1");
        System.out.println("x <= -1");
        System.out.println("//  Block 4");
        System.out.println("y <= " + k(5,-2,6,-1) + " * x + " + b(5,-2,6,-1));
        System.out.println("y >= " + k(5,-2,7,-3) + " * x + " + b(5,-2,7,-3));
        System.out.println("y <= " + k(6,-1,7,-3) + " * x + " + b(6,-1,7,-3));
        System.out.println("//  Block 5");
        System.out.println("y <= Math.pow(Math.pow(2,2) - Math.pow(x-4,2),1/2.f) -1");
        System.out.println("y >= " + k(2,-1,4,1) + " * x + " + b(2,-1,4,1));
        System.out.println("y >= -1 * (Math.pow(Math.pow(2,2) - Math.pow(x-4,2),1/2.f)) -1");
        System.out.println("y <= " + k(4,-3,6,-1) + " * x + " + b(4,-3,6,-1));
        System.out.println("//  Block 6 вычернуть");
        System.out.println("y <= " + k(-5,0,0,1) + " * x + " + b(-5,0,0,1));
        System.out.println("y >= " + k(-5,-3,0,-5) + " * x + " + b(-5,-3,0,-5));
        System.out.println("y <= " + k(3,0,4,-2) + " * x + " + b(3,0,4,-2));
    }
